...
export const myProjects: Projects[] = [
    {
      ...
      details:
        "Dog Hotel Booking Systems is a hotel booking system designed for dogs, where users can manage their own bookings and reservations. This is a booking platform built for dog lovers — a project I created to simulate reservation flow while combining it with my personal passion for dogs.",
      introPage:
        "A full-stack web application designed for dog lovers to book cozy hotel rooms for their furry friends. This project was created because of my love for dogs, and to explore the process of designing simulated web systems from scratch.",
      projectOverviewPage:
    ...
    projectOverviewPage: "Quote Collection is a simple web application that allows users to browse, collect, and create their favorite quotes. This project was built to practice working with APIs, dynamic routing, and form handling while focusing on delivering a clean and intuitive user experience. The idea behind this project was to create a space that feels personal and inspiring — a digital notebook for thoughts and wisdom. I also plan to improve the UI/UX further based on user feedback and make the interface more modern and engaging.",
    technology: ["HTML",
            "JavaScript",
            "React",
            "Tailwind CSS",
      ...
      },
    {
      ...
      project: "Portfolio",
      details:
        "Portfolio is a responsive personal portfolio built to showcase my full-stack projects, technical skills, and background. Designed with clean UI/UX principles using React, Tailwind CSS, and TypeScript. Includes live project demos, GitHub links, and a section about me.",
      introPage:
